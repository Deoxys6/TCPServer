   ...
   // public static Int32[][] identifyMusic(String filePath)
    //{
        ...
        for (int x = 0; x < contentsOfFile.Count; x++)
        {
            ...
            //This splits the duration into a char array index 0 is the numerator, index 1 is the slash(division sign), index 2 is the denominator
        ...
        //returns the array of music notes and their durations
        //return theActualArrayThatIsNeededToBePlayed;
    }
}
